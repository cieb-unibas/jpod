...
if __name__ == "__main__":
    ...
    df = pd.read_csv("data/bloom_fields.csv")
    df = pd.merge(df, pd.read_csv("data/key_words_tech.csv"), on = "bloom_code")
    ...
    print("Translated keywords of Bloom et al. (2020) saved.")

    ### AI-Keywords from Acemoglu et al. (2022) --------------------------------------
    with open("data/acemoglu_ai_keywords.txt") as f:
    ...
    print("Translated keywords of Acemoglu et al. (2022) saved.")
